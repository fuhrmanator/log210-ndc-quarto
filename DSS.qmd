...
En d'autres mots, c'est la façon (normalisée et documentée) qu'un programme d'application communique avec un ensemble d'éléments logiciels qu'il utilise pour faire une application utile.
