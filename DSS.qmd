...
C'est à vous de juger si votre DSS avec des `opt` ou des `alt` est assez simple ou fait du *spaghetti*.
...
Toutes les opérations système doivent définir le type de chaque argument, le cas échéant.
