...
La complexité circonstancielle peut être gérée avec des technologies, par exemple les débogueurs, les patterns de conception (un Adaptateur pour les différentes bases de données), etc.
