...
![Rétroaction et adaptation itératives convergent vers le système souhaité [@craig_uml_2005, figure 2.2].](images/F2.2.svg){#fig-StabiliteDansLesIterations}

![Analyse et conception évolutives, majoritairement effectuées dans les premières itérations [@craig_uml_2005, figure 2.4].](images/F2.4.svg){#fig-AnalyseConceptionDansLesIterations}
