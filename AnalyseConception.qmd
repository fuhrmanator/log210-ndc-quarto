...
Cette œuvre vise à décrire une méthodologie de développement de logiciel qui répond à ces questions.
...
Dans le fond, c'est faire une _analyse_ d'un domaine d'application et proposer une _conception_ du logiciel à développer dans le domaine visé.
...
Orthogonalement, surtout pour faire face à la complexité, la méthodologie propose ces activités en itérations ayant une durée relativement courte (1 à 3 semaines), dans lesquelles on réalise un sous-ensemble du système à développer et on le présente au client pour avoir sa rétroaction.
...
![Survol de la méthodologie.](images/Methodologie-survol-export_from_drawio_as_SVG_convert_labels_to_SVG.svg){#fig-SurvolMethodologie}
...
![Processus itératif et incrémental (évolutif).](images/F2.1_adaptée.svg){#fig-IteratifEvolutif}
...
![Pour respecter la méthode du temps limité, on peut modifier les objectifs d'une itération si le travail est trop important [adaptation de @craig_uml_2005, figure 2.4].](images/F2.4_adaptée.svg){#fig-AnalyseConceptionDansLesIterations}
