...
- Un _pattern de conception_ peut être complexe, par exemple les _patterns_ Visiteur, Décorateur, Médiateur, etc., de @GoF1994.
Un _pattern_ définit des rôles et parfois du code et des classes supplémentaires à créer.
...
La complexité circonstancielle (aussi appelée accidentelle) peut être gérée avec des technologies, par exemple les débogueurs, les _patterns_ de conception (un Adaptateur pour les différentes bases de données), etc.
