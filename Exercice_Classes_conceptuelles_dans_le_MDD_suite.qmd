...
1. Considérez les  [classes candidates identifiées par catégorie et les groupes nominaux](#sec-classes) provenant de l’exercice précédent (une liste est présente dans la @sec-groups).
