...
Les MDD sont expliqués en détail dans le chapitre 9 \faBook<i class="fa-solid fa-book"></i>, mais voici des points importants pour LOG210:
...
- Faites attention à l'attribut qui devrait être une classe. Si on ne pense pas un attribut *X* en termes alphanumériques dans le monde réel, alors il s'agit probablement d'une classe conceptuelle. Voir la section 9.12 \faBook<i class="fa-solid fa-book"></i>.
...
Voici la réponse de Craig Larman dans la section 9.2 \faBook<i class="fa-solid fa-book"></i>:
