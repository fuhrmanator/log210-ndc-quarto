...
Les classes d'association dans un MDD sont le sujet de la section A31.10/F26.10 \faBook<i class="fa-solid fa-book"></i>.
...
Les détails de cette approche sont présentés dans le chapitre F26/A31 \faBook<i class="fa-solid fa-book"></i>.
...
Commencez par souligner ou mettre en surbrillance les noms et les groupes nominaux dans le [cas d'utilisation _Réserver un livre de la bibliothèque_](#sec-CU_Réserver_livre).
...
Comparez la liste de classes trouvées dans @exr-MDD-trouver-classes-conceptuelles-noms avec les classes trouvées dans @exr-MDD-trouver-classes-conceptuelles-catégorie.
