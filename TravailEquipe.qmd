...
```{.plantuml #fig-moi_inf_equipe caption="Une personne humble va accepter une décision prise par l'équipe, même si elle n'est pas en accord à 100%." width=200px}
@startuml
