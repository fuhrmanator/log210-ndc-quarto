...
Cependant, les enseignants et les chargés de laboratoire s'attendront à ce que vous ayez pensé à un plan B avant de perdre le coéquipier.
...
Si les plus forts n'aident pas les autres, ils risquent de les éloigner de l'équipe et de se trouver seuls sur le plan des contributions techniques. Voir la section sur la [Redondance des compétences dans l’équipe (Bus Factor)](#sec-Bus_Factor).
