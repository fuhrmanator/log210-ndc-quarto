...
C'est le nombre minimum de membres à perdre (par exemple, heurtés par un bus) pour arrêter le projet par manque de personnel bien informé ou compétent.
...
L'automatisation des tests dans un processus de construction de logiciel (*build process*) à la devops (@sec-tdd) aide aussi, car l'équipe ne dépend pas d'une personne pour rouler les tests et valider le code.
...
- un membre de l'équipe suit cinq (!) cours en même temps et n'a pas le temps adéquat pour travailler correctement dans les laboratoires de cette matière.
- plusieurs membres de l'équipe sont "expérimentés" mais ils ont de la difficulté à s'entendre sur la direction du projet.
