...
En mode esquisse, lorsqu'on dessine un modèle sur un tableau blanc ou un papier, un outil pratique pour numériser le tout est **Microsoft Lens** ([Android](https://play.google.com/store/apps/details?id=com.microsoft.office.officelens&hl=fr_CA) ou [iOS](https://apps.apple.com/ca/app/microsoft-office-lens-pdf-scan/id975925059)).
...
![Capture](images/Before-Office_Lens.jpg){#fig-beforeLens}

![Résultat](images/After-Office_Lens.jpg){#fig-afterLens}

Microsoft Lens peut détecter le cadre d'un dessin sur un tableau blanc ou papier et le transformer, même si on n'est pas droit devant le dessin.
:::
...
- il est basé sur un langage spécifique à un domaine (anglais *domain-specific language* ou DSL), dont les fichiers peuvent être facilement mis sur contrôle de version (git);
