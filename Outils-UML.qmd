...
> Tous les travaux demandés pour les **examens** de LOG210 doivent être faits *à la main*.
...
Dans le menu "Select sample diagram" de PlantUML Gizmo (Google Docs), il y a plusieurs exemples de diagrammes utilisés dans le cadre de LOG210 (voir la @fig-GizmoSamples).
