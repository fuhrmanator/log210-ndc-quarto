...
Le chapitre F20/A22\ {{< fa solid book >}}\ définit quelques termes importants pour la modélisation avec UML et les outils.
...
- il existe plusieurs supports pour les outils de documentation:
  - extension [PlantUML pour VisualStudio Code](https://marketplace.visualstudio.com/items?itemName=jebbs.plantuml) (@fig-PlantUMLVSCode) avec [tutoriel](https://www.youtube.com/watch?v=xkwJ9GwgZJU)\ {{< fa brands youtube >}};
