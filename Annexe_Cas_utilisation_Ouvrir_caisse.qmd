...
Notez les nouvelles classes conceptuelles **Plateau-billets** (un objet physique) et **MisePlateau** (une transaction) faisant partie du scénario d'*Ouvrir la caisse*.
...
-   *mp* a été associée à un Plateau-Billets, sur la base de correspondance avec **identifiant**.
-   Le Registre en cours a été associé à un Plateau-Billets, sur la base de correspondance avec **identifiant**.
