...
![Modèle du domaine partiel pour le système POS NextGen présentant les différences par rapport au modèle du domaine de base présenté par Larman. Avec l'ajout des classes conceptuelles PlateauBillets et MisePlateau, qui modélisent des nouveaux éléments du cas d'utilisation "Ouvrir la caisse".](images/MDD_POS_NextGen_export.svg)
