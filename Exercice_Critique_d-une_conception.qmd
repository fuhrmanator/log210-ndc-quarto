...
Un objectif secondaire est de considérer les choix de conception sur un plan de la cohésion et du couplage. 
Ici, il s'agit du jeu de Monopoly, qui est un exemple proposé par @craig_uml_2005 pour lequel il a également proposé un modèle du domaine et une conception, selon la méthodologie.

Pour cet exercice, nous examinerons une conception orientée objet réelle du jeu de Monopoly disponible sur GitHub, soit [Emojiopoly](https://github.com/Chuzzy/Emojiopoly). Voici le travail à faire.

- Considérez les deux artefacts:
    - un [modèle du domaine de Monopoly](#sec-MDD_Monopoly) proposé par @craig_uml_2005 (il y a une version en français et en anglais, puisque le code TypeScript est en anglais) et 
...
- Nous faisons une hypothèse que l'équipe qui a développé Emojiopoly n'ait pas commencé avec le MDD de Larman.
- Comparez ces deux artefacts et faites des remarques sur la conception, **surtout par rapport au MDD et le décalage des représentations**.
