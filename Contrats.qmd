...
![Les postconditions décrivent la manipulation d'objets dans un MDD (la partie inférieure ici est un diagramme d'objets)](images/MDD-Risk-contrats.export_as.advanced.drawio.pdf){#fig-MDD-risk-objets}
