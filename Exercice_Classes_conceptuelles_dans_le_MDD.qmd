...
À partir du [cas d’utilisation de la section 1](#sec-usecases), esquissez le Modèle du domaine correspondant au
domaine de l’application.

1. Considérez les   [classes candidates identifiées par catégorie et les groupes nominaux](#sec-classes) provenant de l’exercice précédent (une liste est dans la section 2).
...
## Section 2 :  Classes candidates et groupes nominaux{#sec-classes}
