# Exercice : Classes conceptuelles dans le MDD {#sec-ExerciceClassesConceptuellesMDD}

À partir du [cas d'utilisation _Réserver un livre de la bibliothèque_](#sec-CU_Réserver_livre), trouvez des
classes conceptuelles candidates avec les deux méthodes proposées dans la **section 9.5** de @craig_uml_2005:

-   En utilisant une liste de [**catégories de classes**](#sec-categoriesClasses)
-   À l'aide de groupes nominaux

## Par catégories de classes {.unnumbered .unlisted}
...
## À l'aide de groupes nominaux {.unnumbered .unlisted}

C'est l'analyse linguistique consistant à repérer (souligner ou mettre en surbrillance) les noms et les groupes nominaux dans la description textuelle d'un domaine (dans cet exercice, c'est le [cas d'utilisation _Réserver un livre de la bibliothèque_](#sec-CU_Réserver_livre)).

\newpage

## Cas d'utilisation - Réserver un livre de la bibliothèque {#sec-CU_Réserver_livre .unnumbered .unlisted}
