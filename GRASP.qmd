...
Appliquez les patrons GRASP Protection des variations et Fabrication pure pour améliorer la cohésion de `ReservationManager`.
Pour être concis, la gestion des réservations dans l'application est omise.

```javascript
class ReservationManager {
    public addReservation(String memberId, String bookCopy, String bookCopyId, Date expiration) {
        // We get the book info from the map
        var book = books.get(book);
        ...
        // Reference https://developers.google.com/calendar/api/v3/reference?hl=fr
        ...
        var event = {
            ...
            "description": "You must return your book tommorow to avoid late fees.",
            "start": {
                "date": dateAsString,
