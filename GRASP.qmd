...
## Exercice GRASP Polymorphisme

Soit le diagramme de classe modélisant l’exemple à [<u>Replace Conditional with Polymorphism</u>](https://refactoring.com/catalog/replaceConditionalWithPolymorphism.html):
...
```{.plantuml}
    ...
    Bird : type : String
    Bird : numberOfCoconuts : number
    Bird : voltage : number

    Bird : getPlumage() : String
