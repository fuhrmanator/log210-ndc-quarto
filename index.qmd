...
Cet ouvrage a commencé comme notes de cours pour le cours _Analyse et conception de logiciels (LOG210)_ dans les programmes de baccalauréat en génie logiciel (LOG) et en génie des technologies de l'information (GTI) de l'École de technologie supérieure (ÉTS) à Montréal, au Québec.
...
- l'application des patterns de conception de la "Bande des quatre" (Gang of Four): Gamma, Helm, Johnson et Vlissides @GoF1994.
...
Elle permet de valoriser le travail réalisé par un(e) membre du corps professoral dans la rédaction d'un manuel libre pour un cours universitaire.
