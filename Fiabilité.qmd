...
- Définitions des termes, A36.3/F30.3\ {{< fa solid book >}}:
...
- Les solutions proposées par l'architecte système et documentées par Larman impliquent les concepts suivants:
  ...
  - Utilisation de *Procuration (Proxy) de redirection \[GoF\]* pour basculer sur un service local en cas de panne (écriture d'information), A36.4/F30.4\ {{< fa solid book >}}
