...
- Les solutions proposées par l'architecte système et documentées par Larman impliquent les concepts suivants:
  ...
  - Utilisation d'Adaptateur [@GoF1994] pour réaliser le service redondant (lecture d'information), A36.2/F30.2\ {{< fa solid book >}}.
  ...
  - Utilisation de Procuration (Proxy) de redirection [@GoF1994] pour basculer vers un service local en cas de panne (écriture d'information), A36.4/F30.4\ {{< fa solid book >}}.
