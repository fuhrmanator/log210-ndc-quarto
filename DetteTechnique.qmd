...
Ce chapitre contient des informations sur le concept de la [dette technique](https://fr.wikipedia.org/wiki/Dette_technique)\ {{< fa brands wikipedia-w >}}, qui n'est pas un sujet abordé explicitement par @craig_uml_2005.
...
Comme c'est une métaphore puissante, beaucoup de développeurs l'utilisent et c'est un terme avec une certaine popularité. 
