...
Le diagramme suivant a été fait avec PlantUML dans une RDCU et il
contient des erreurs de logique (flot) et de conception (visibilité).
...
-   Créer une instance e de la classe E

-   Associer (stocker) cette instance à (dans) :B et aussi à (dans) :D

Le code source de ce diagramme est disponible
[ici](http://www.plantuml.com/plantuml/uml/NS-n3eCW40RW_PxYmjGE3Ereh17HiGznmOiXAhM0Gz--Y4DJ5lB_7tz8Q4Ca7_TrWJ1Rjv6d5KFyB9nERqrvm--TdU4dXq0JgyLE3Wsxo1xI8bfZDt8HHQK4Ka1LQ9UrArHdrONsMVj_vMh8F0381XLMkDv0OShwo7S0uvaYfu56APi6X-JyEFLSTabe72zy1Ntq_jVhMihygdZD0bfsO_h_5m00).

Cependant, **il sera impossible de coder cette RDCU en TypeScript**
telle quelle, pour plusieurs raisons. Les voyez-vous?

Astuce: Il y a des problèmes de séquencement de message (flot) et aussi
de visibilité d’objets (e:E).

1.  Quel est le problème avec le message add(e) de :A à :B?

2.  Quel est le problème avec le message add(e) de :C à :D?

3.  Proposez une solution (plusieurs sont possibles) pour corriger les
    erreurs dans le diagramme.
