...
3. Écrivez le code pour l'utilisation d'un *Cornet* (à dès, gobelet dans lequel on agite les dés) dans le jeu Monopoly [@craig_uml_2005], figure F22.9/A25.9\ {{< fa solid book >}}].
