...
Larman vous propose un idiome (pas vraiment un _pattern_) nommé **Transformer identifiant en objet** qui sert à repérer la référence d'un objet qui correspond à l'identifiant.
